  ...
  return html`
    <section class="card">
      ...
      <div class="filters" style="margin-top: 14px;">
        ...
        <div class="muted">${tp("skills.shownCount", { count: String(filtered.length) })}</div>
      </div>
...
function renderSkill(skill: SkillStatusEntry, props: SkillsProps) {
  ...
  if (skill.disabled) reasons.push(t("skills.reasons.disabled"));
  if (skill.blockedByAllowlist) reasons.push(t("skills.reasons.blockedByAllowlist"));
  return html`
    <div class="list-item">
      <div class="list-main">
        ...
        <div class="chip-row" style="margin-top: 6px;">
          ...
          ${skill.disabled
            ? html`<span class="chip chip-warn">${t("skills.status.disabled")}</span>`
            : nothing}
        </div>
        ${missing.length > 0
          ? html`
