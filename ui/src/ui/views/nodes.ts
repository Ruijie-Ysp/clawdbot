      ...
      <div class="list" style="margin-top: 16px;">
        ${
          props.nodes.length === 0
            ? html`
                <div class="muted">${t("nodes.noneFound")}</div>
              `
    ...
    <section class="card">
      ...
      <div class="list" style="margin-top: 16px;">
        ...
        ${
          paired.length > 0
            ? html`
              <div class="muted" style="margin-top: 12px; margin-bottom: 8px;">${t("nodes.devices.paired")}</div>
        ...
        ${
          pending.length === 0 && paired.length === 0
            ? html`
                <div class="muted">${t("nodes.devices.none")}</div>
              `
            : nothing
        }
      </div>
...
function renderPendingDevice(req: PendingDevice, props: NodesProps) {
  ...
  const role = tp("nodes.devices.roleLabel", { role: req.role?.trim() || "-" });
  ...
  return html`
    <div class="list-item">
      <div class="list-main">
        ...
        <div class="muted" style="margin-top: 6px;">${role} · ${tp("nodes.devices.requested", { age })}${repair}</div>
      </div>
      <div class="list-meta">
    ...
    <div class="list-item">
      <div class="list-main">
        ...
        ${
          tokens.length === 0
            ? html`
                <div class="muted" style="margin-top: 6px">${t("nodes.devices.tokensNone")}</div>
              `
            : html`
...
function resolveSecurityLabel(value: ExecSecurity): string {
  return t(`nodes.execApprovalsOptions.security.${value}`);
}

function resolveAskLabel(value: ExecAsk): string {
  return t(`nodes.execApprovalsOptions.ask.${value === "on-miss" ? "onMiss" : value}`);
}
              ...
              <div class="list-item">
                ...
                <div class="list-meta">
                  ...
                  ${
                    !supportsBinding
                      ? html`
                          <div class="muted">${t("nodes.bindings.noNodes")}</div>
                        `
                      : nothing
                  }
                </div>
    ...
    <section class="card">
      <div class="row" style="justify-content: space-between; align-items: center;">
        <div>
          ...
          <div class="card-sub">
            ${t("nodes.execApprovals.subtitle")}
          </div>
        </div>
        <button
          class="btn"
    ...
    <div class="list" style="margin-top: 12px;">
      ...
      ${
        state.target === "node" && !hasNodes
          ? html`
              <div class="muted">${t("nodes.execApprovals.noNodes")}</div>
            `
          : nothing
      }
    </div>
          ...
          <div class="list-sub">
            ${
              isDefaults
                ...
                : tp("nodes.execApprovals.securitySubtitleValue", {
              ...
              ${
                !isDefaults
                  ? html`<option value="__default__" ?selected=${securityValue === "__default__"}>
                    ${tp("nodes.execApprovals.useDefault", { value: resolveSecurityLabel(defaults.security) })}
                  </option>`
                  : nothing
              }
          ...
          <div class="list-sub">
            ${
              isDefaults
                ...
                : tp("nodes.execApprovals.askSubtitleValue", {
              ...
              ${
                !isDefaults
                  ? html`<option value="__default__" ?selected=${askValue === "__default__"}>
                    ${tp("nodes.execApprovals.useDefault", { value: resolveAskLabel(defaults.ask) })}
                  </option>`
                  : nothing
              }
              ${ASK_OPTIONS.map(
              ...
              ${
                !isDefaults
                  ? html`<option value="__default__" ?selected=${askFallbackValue === "__default__"}>
                    ${tp("nodes.execApprovals.useDefault", { value: resolveSecurityLabel(defaults.askFallback) })}
                  </option>`
                  : nothing
              }
              ${SECURITY_OPTIONS.map(
          ...
          <div class="list-sub">
            ${
              isDefaults
                ...
                : autoIsDefault
                  ? tp("nodes.execApprovals.autoAllowUsingDefault", {
        ...
        <div class="list-meta">
          ...
          ${
            !isDefaults && !autoIsDefault
              ...
              >
                ${tp("nodes.execApprovals.useDefault", {
  ...
  return html`
    ...
    <div class="list" style="margin-top: 12px;">
      ${
        entries.length === 0
          ? html`
              <div class="muted">${t("nodes.execApprovals.noAllowlist")}</div>
            `
        ...
        <div class="list-sub">
          ...
          ${
            bindingValue === "__default__"
              ...
              : tp("nodes.bindings.override", { value: agent.binding ?? "" })
          }
        </div>
      </div>
      <div class="list-meta">
        <label class="field">
          ...
          >
            <option value="__default__" ?selected=${bindingValue === "__default__"}>
              ${tp("nodes.execApprovals.useDefault", { value: defaultLabel })}
            </option>
            ${state.nodes.map(
              (node) =>
                html`<option
