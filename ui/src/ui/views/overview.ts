...
export function renderOverview(props: OverviewProps) {
  ...
  const authHint = (() => {
      ...
      return html`
        <div class="muted" style="margin-top: 8px;">
          ...
          <div style="margin-top: 6px;">
            <span class="mono">clawdbot dashboard --no-open</span> →
            ${t("overview.authHint.tokenizedUrl")}<br />
            <span class="mono">clawdbot doctor --generate-gateway-token</span> →
            ${t("overview.authHint.setToken")}
          </div>
          <div style="margin-top: 6px;">
            <a
              class="session-link"
    ...
    return html`
      <div class="muted" style="margin-top: 8px;">
        ...
        <span class="mono">clawdbot dashboard --no-open</span>,
        ${t("overview.authHint.failedOutro")}
        <div style="margin-top: 6px;">
          <a
            class="session-link"
            href="https://docs.clawd.bot/web/dashboard"
  ...
  const insecureContextHint = (() => {
    ...
    return html`
      <div class="muted" style="margin-top: 8px;">
        ${t("overview.insecureHint.httpBlocked")}
        ${tp("overview.insecureHint.useHttps", { url: "http://127.0.0.1:18789" })}
        <div style="margin-top: 6px;">
          ${tp("overview.insecureHint.allowInsecure", {
            configKey: "gateway.controlUi.allowInsecureAuth: true",
          })}
        </div>
        <div style="margin-top: 6px;">
          <a
  ...
  return html`
    ...
    <section class="grid grid-cols-3" style="margin-top: 18px;">
      ...
      <div class="card stat-card">
        ...
        <div class="muted">
          ${tp("overview.stats.nextWake", { value: formatNextRun(props.cronNext) })}
        </div>
      </div>
    </section>
    ...
    <section class="card" style="margin-top: 18px;">
      ...
      <div class="note-grid" style="margin-top: 14px;">
        <div>
          ...
          <div class="muted">${t("overview.notes.tailscaleBody")}</div>
        </div>
        <div>
