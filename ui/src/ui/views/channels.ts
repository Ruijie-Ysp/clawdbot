...
import { channelEnabled, formatBool, renderChannelAccountCount } from "./channels.shared";
...
function formatStatus(value: StatusValue): string {
  switch (value) {
    case "yes":
      return t("common.yes");
    case "no":
