  ...
  <body>
    <main>
      <section class="surface hero">
        <div class="hero-head">
          <div class="hero-copy">
            <h1>OpenClaw Weixin（微信通道增强）</h1>
            <p>让一个 OpenClaw 机器人同时服务多个微信，并统一管理微信登录。已预留 Codex、Claude Code、Coser 等机器人入口。</p>
            <div class="hero-links">
              <a href="https://github.com/openclaw/openclaw" target="_blank" rel="noreferrer">https://github.com/openclaw/openclaw</a>
            </div>
          </div>
